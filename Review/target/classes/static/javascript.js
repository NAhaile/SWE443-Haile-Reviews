...
function test() {
	...
	.then(data => {
		...
		document.getElementById('mili').innerHTML = data.dateTimeMilli;
...
function manip() {
	...
	.then(data => {
			...
			var dateTime = date+' '+time;
				...
				document.getElementById('mili').innerHTML += dateTime + "<br />";
				document.getElementById('content').innerHTML += foo + "<br />";
